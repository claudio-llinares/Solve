...
c  begin abort action
  500 continue
c
c      write(6,505) ind, tol, x, n, c(13), xend, nw, c(16), c(20),
c     +      c(22), c(23), c(24), (y(k), k = 1, n)
c  505 format( /// 1h0, 58hcomputation stopped in dverk with the followin
c     +g values -
...
c     +   // (1h , 1p5d24.15)                                           )
	write(*,*) "dverk.f: Lines modified in original code.  Please, see the source."
c
      stop
c
c  end abort action
